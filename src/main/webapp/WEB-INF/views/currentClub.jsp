...
<ct:page title="currentClub">    
    <jsp:body>
        ...
        <form:form action="/currentClub" method="post" modelAttribute="DataTransferModel">
            <h3>Club: ${currentClub.clubName}</h3>
            <h3>Telephone:  ${currentClub.tel}</h3>
            <h3>Email:  ${currentClub.email}</h3>

            <fieldset >
                <legend> <b>The club offers</b></legend>
                <p>Personal training</p>
                <p>     Training for groups</p>
                <p>            Team building</p>
            </fieldset>
             <br />    <br /> 
